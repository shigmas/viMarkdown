...
- **Powerful Grep (Global Search) Feature**
  Quickly extract target text across multiple files or entire directories, strongly supporting efficient document search and bulk editing.
