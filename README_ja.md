...
|0.4|viコマンド、メニュー等日本語対応、正規表現検索、grep, 矩形選択、SVGブロック？、使い勝手向上、パフォーマンス向上、CMake化（QtCreator/Mac/Linux対応）|2026/04頃dev版、07頃Alpha版開始予定。2026/10～12 安定版（Win版・Mac版）リリース予定
