...
- **罫線ブロック:** テキストの罫線記号を使ってクラス図、UIモックアップなどの図を簡単に描くことができます。
  ...
  [簡単な入門](viMarkdown-quickstart.md)
...
- **学生特別枠:** 学生（大学院生、大学生、研究生、高専生、中高生、小学生、幼稚園児）は、目的を問わず**すべて無料**です。
...
|0.1.1xx|Alpha|問題対処・場合によっては機能実装|2026/02/Mid～|
...
|ver.|概要|スケジュール|
|----|----|----|
|0.2|基本エディタ機能、基本マークダウン、罫線ブロック|2026/04 頃リリース予定
|0.4|viコマンド、CSVブロック、日本語対応、使い勝手向上、パフォーマンス向上|2026/04 頃dev版開発開始、リリース時期未定
|0.6|数式表示、マインドマップ・ページビュー・プレゼンモード？|未定|
|0.8|マーメイド？, プレビューワ上での編集？|未定|
