...
- **マークダウンプレビュー:** 編集内容をリアルタイムにプレビュー表示します。プレビュー上で簡単な編集も可能です。
...
|0.1.1xx|alpha|問題対処・リファクタリング・ドキュメント作成・軽微な機能実装|2026/02/10～（←**いまここ**）|
|0.1.2xx|beta|問題対処・ドキュメント作成|2026/03/10～|
|0.2.xxx|rc|副作用の心配ない問題対処のみ|2026/03/23～|
...
|　ver.　|　概要　|　スケジュール　|
|:---:|----|----|
|0.2|基本エディタ機能、基本マークダウン、罫線ブロック、CSVブロック、プレビューワ上編集（限定的）|2026/04 リリース予定
|0.4|viコマンド、メニュー等日本語対応、使い勝手向上、パフォーマンス向上、CMake化|2026/04頃dev版、07頃Alpha版開始予定。安定版リリース時期未定
