...
|　ver.　|　概要　|　スケジュール　|
|:---:|----|----|
|0.2|基本エディタ機能、基本マークダウン、罫線ブロック、CSVブロック、プレビューワ上編集（限定的）|2026/04 安定版リリース予定
|0.4|viコマンド、メニュー等日本語対応、grep, 矩形選択、使い勝手向上、パフォーマンス向上、CMake化|2026/04頃dev版、07頃Alpha版開始予定。安定版リリース時期未定
|0.6|数式表示、マインドマップ・ページビュー・プレゼンモード？、フォルダ表示？|未定|
|0.8|マーメイド？|未定|
|1.0|未定|未定|
