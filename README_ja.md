...
|0.2.xxx|rc|副作用の心配ない問題対処のみ|2026/04/中旬～|
|0.2.xxx|Stable|メンテナンスモード|2026/04/下旬～|
...
|0.4|viコマンド、メニュー等日本語対応、正規表現検索、grep, 矩形選択、SVGブロック？、使い勝手向上、パフォーマンス向上、CMake化（QtCreator/Mac/Linux？対応）|2026/05頃dev版、08頃alpha版、10頃beta版開始予定。2026/12頃 RC版・安定版（Win版・Mac版バイナリ？）リリース予定
