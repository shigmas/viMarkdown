...
|0.4|viコマンド、メニュー等日本語・英語対応、正規表現検索、grep, diff?, 矩形選択?、SVGブロック、グラフビュー？、使い勝手向上、パフォーマンス向上、CMake化（QtCreator/Mac/Linux？対応）|2026/05 dev版、08 alpha版、10 beta版開始予定。2026/12 RC版・安定版（Win版・Mac版?バイナリ）リリース予定
